...
namespace Flickr_Set_Downloader
{
    ...
    public partial class About : Window
    {
        ...
        {
            get { return ( CalculatePropertyValue<AssemblyDescriptionAttribute>(propertyNameDescription, xPathDescription) + Upcoming); }
        }
